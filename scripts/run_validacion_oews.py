...
`data/reference/oews_medianas_2025.json` para que el resultado no dependa de
...
Artefactos: results/validacion_oews.json

Uso:
    python scripts/run_validacion_oews.py
"""
...
SEMILLA = 42
ANIO = "2025"
REFERENCIA = RAIZ / "data" / "reference" / "oews_medianas_2025.json"
SALIDA = RAIZ / "results" / "validacion_oews.json"

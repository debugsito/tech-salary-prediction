...
from src.feature_pipeline_so import preparar_xy, construir_preprocesador, nombres_de_variables
...
shap_res = explicar(tuberias[mejor], X_ent, X_pru,
                    ...
                    directorio=str(RAIZ / "results_colab"),
...
t22.fit(Xe, ye)
p22 = t22.predict(Xp)
print(f"R² sobre prueba (2022): {compute_metrics(yp, p22)['R2']:.4f}")

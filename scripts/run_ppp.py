...
Artefactos: results/ppp_comparativa.json

Uso:
    python scripts/run_ppp.py
"""
...
SEMILLA = 42
REFERENCIA = RAIZ / "data" / "reference" / "ppp_factors.csv"
SALIDA = RAIZ / "results" / "ppp_comparativa.json"

...
Salida: data/reference/country_income_groups.csv
...
Uso:
    python scripts/build_country_reference.py
"""
...
def main():
    ...
    ap.add_argument("--data-dir", default="data/external")
    ap.add_argument("--out", default="data/reference/country_income_groups.csv")
    args = ap.parse_args()

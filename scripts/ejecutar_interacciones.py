...
Salida:
    resultados/interacciones.csv       Fuerza de interacción por par de variables
    figuras/shap_dependencia_*.png  Gráficos de dependencia con coloreado

Uso:
    python scripts/ejecutar_interacciones.py
"""
...
def main():
    ...
    ap.add_argument("--fig-dir", default="figuras")
    args = ap.parse_args()
    ...
    resumen = pd.read_csv(res / f"shap_resumen_{args.etiqueta}.csv")

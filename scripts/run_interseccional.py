...
Salida: results/fairness_interseccional_2022.json y .md
"""
...
def main():
    ...
    lineas = ["# Análisis interseccional de equidad — edición 2022", "",
              "> Generado por `scripts/run_interseccional.py`. No editar a mano.", "",
    ...
    salida = Path("results")
    (salida / "fairness_interseccional_2022.md").write_text("\n".join(lineas), encoding="utf-8")
    (salida / "fairness_interseccional_2022.json").write_text(
